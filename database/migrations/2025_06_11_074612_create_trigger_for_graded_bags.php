    ...
    public function up(): void
    {
        DB::unprepared("
            ...
            BEGIN
                ...
                WHERE party_id = NEW.party_id AND item_id = NEW.item_id AND grade_id = NEW.grade_id AND weight_id = NEW.weight_id;
        ...
        DB::unprepared("
            ...
            BEGIN
                UPDATE export_stocks
                SET quantity = quantity - 1
                WHERE party_id = OLD.party_id AND item_id = OLD.item_id AND grade_id = OLD.grade_id AND weight_id = OLD.weight_id;
