...
export default function EditPartyForm({ party, onSuccess }: Props) {
    ...
    const handleSubmit: FormEventHandler = async (e) => {
        ...
        try {
            const response = await axios.put(`/parties/${party.id}`, data, {
                headers: {
            ...
            if (error.response?.status === 422) {
                ...
                toast.error('Failed to update party. Please try again later.');
            }
        } finally {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid gap-4">
                ...
                <div className="grid gap-2">
                    ...
                    />
                    {errors.address_line_1 && <p className="text-destructive text-sm">{errors.address_line_1}</p>}
                </div>
                ...
                <div className="grid gap-2">
                    ...
                    />
                    {errors.address_line_2 && <p className="text-destructive text-sm">{errors.address_line_2}</p>}
                </div>
                ...
                <div className="grid gap-2">
                    ...
                    />
                    {errors.gst && <p className="text-destructive text-sm">{errors.gst}</p>}
                </div>
            </div>
